          ...
          data.calendarDays.forEach(info => {
             ...
             card.innerHTML = `
                  <div class="card-body" style="background-color: ${backgroundColor};">
                      ...
                      ${info.isActive !== "0" ? `<button onclick="openModCalendarDaysAssign();getCalendarDaysAssign1(&quot;${info.calendarId}&quot;);" class="btn btn-primary1 edit-button" title="DÍAS DISPONIBLES"><i class="fas fa-calendar-alt"></i></button>` : ''}
                  </div>
              `;
  ...
  fetch(epGetCalendarDaysAssign + param+"/admin")
      ...
      .then(data => {
          ...
          data.calendarDaysAssign.forEach(info => {
              ...
              console.log(epGetCalendarDaysAssign);
          });
          document.getElementById("loading-container").style.display = "none";
      })
      .catch(error => {
