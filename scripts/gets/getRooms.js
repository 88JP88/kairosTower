...
async function getClientRoomsPromise(data, containerData, containerInfo) {
  ...
  async function getClientRooms(data, containerData, containerInfo) {
    try {
        const message = await getClientRoomsPromise(data, containerData, containerInfo);
