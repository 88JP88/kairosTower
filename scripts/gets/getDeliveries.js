  ...
  async function getDeliveryPromise(data, containerData, containerInfo,modelView) {
    ...
    if(modelView=="table"){
      ...
      card11Info.classList.add("card");
          ...
          card11Info.innerHTML = ` <p><H4>REPARTIDORES</H4></p><p>${data.response.apiMessage}</p>`;
  ...
  'Eliminar'
    ...
    select.id = 'clientDeliveryFilter';
    select.classList.add('form-control');
    select.name = 'currency';
    select.required = true;
   
    const option2 = document.createElement('option');
    option2.value = 'deliveryName';
    option2.textContent = 'Nombre repartidor';
    const option3 = document.createElement('option');
    option3.value = 'deliveryLastName';
    option3.textContent = 'Apellido repartidor';
    const option4 = document.createElement('option');
    option4.value = 'deliveryMail';
    option4.textContent = 'Correo repartidor';
    const option5 = document.createElement('option');
    option5.value = 'deliveryContact';
    option5.textContent = 'Contacto repartidor';
    ...
    cardContainer11Info.appendChild(div1);
     ...
     input.id = 'clientComerceTypeDelivery';
     ...
     button2.addEventListener('click', function() {
      ...
      var param = document.getElementById("clientDeliveryFilter").value;
var value = document.getElementById("clientComerceTypeDelivery").value;
...
<i class="fas fa-trash"></i>
   ...
   //   getClientCategoriesList3('all','all','all',idin1);
      ...
      idin1++;
                ...
                const card11Info = document.createElement("div");
                card11Info.classList.add("card");
                card11Info.innerHTML = `<p>REPARTIDORES</p><p>${data.response.apiMessage}</p>
...
async function getDelivery(data, containerData, containerInfo,modelView) {
    try {
        const message = await getDeliveryPromise(data, containerData, containerInfo,modelView);
