...
function assignelementbyuser(room,user,assign) {
...
var selectedAssignmentsString = selectedAssignmentselement.join("|"); // Convierte el array en una cadena con valores separados por "|"
