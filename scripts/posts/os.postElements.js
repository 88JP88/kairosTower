...
document.getElementById("postElementBtn").addEventListener("click", function() {
  // Obtén los valores de los campos
  document.getElementById("loading-container").style.display = "flex";
var apiData = {
  "clientId": sessionStorage.getItem('clientNow'),
  "elementName": document.getElementById("elementOSName").value,
  "elementComments": document.getElementById("elementOSComments").value,
  "elementSite": document.getElementById("list-OSSite").value,
  "elementType": document.getElementById("list-OSElementType").value,
  "apiValues":{
    "apiName": "apiOS",
    "apiVersion": "v1",
...
function editOSElement(button, clientId,elementId,param,value,reason) {
