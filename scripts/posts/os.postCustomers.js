...
document.getElementById("postCustomersOSBtn").addEventListener("click", function() {
...
var apiData = {
  ...
  "customerName": document.getElementById("customerOSName").value,
  "customerComments": document.getElementById("customerOSComments").value,
  "customerContact": document.getElementById("customerOSContact").value,
  "customerMail": document.getElementById("customerOSMail").value,
  "customerPlace": document.getElementById("list-OSPlaceOwnerCustomer").value,
  "customerImg": document.getElementById("customerOSImg").value,
  "customerAddress": document.getElementById("customerOSAddress").value,
