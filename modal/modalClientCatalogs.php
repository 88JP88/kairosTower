  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #001219; color: #C70039;">
        ...
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" onclick="closeModClientCatalogs()"></button>
...
<button type="button" class="btn btn-primary1 edit-button1"  style="color: #C70039;" title="VER USUARIOS INACTIVOS"><i class="fas fa-filter" id="filtercatalogsbystoresimple"></i></button>
     ...
     <?php 
     require_once 'layout/formClientCatalogs.php';
     ?>
</div>
...
<script>
function openModClientCatalogs() {
  var myModal = new bootstrap.Modal(document.getElementById('clientCatalogs'));
  myModal.show();
}


function closeModClientCatalogs() {
  var myModal = new bootstrap.Modal(document.getElementById('clientCatalogs'));
  myModal.hide();
