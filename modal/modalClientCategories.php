  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #001219; color: #C70039;">
        ...
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" onclick="closeModClientCategories()"></button>

      </div>
      <div class="modal-body">
      <button type="button" class="btn btn-primary1 edit-button1" onclick="getClientCategories('all','all','all');"  style="color: #C70039;" title="VER USUARIOS ACTIVOS"><i class="fas fa-globe"></i></button>
...
<button type="button" class="btn btn-primary1 edit-button1"  style="color: #C70039;" title="VER USUARIOS INACTIVOS"><i class="fas fa-filter" id="filtercatalogsbystoresimple"></i></button>
     ...
     <?php 
     require_once 'layout/formClientCategories.php';
     ?>
</div>
...
<script>
function openModClientCategories() {
  var myModal = new bootstrap.Modal(document.getElementById('clientCategories'));
  myModal.show();
}


function closeModClientCategories() {
  var myModal = new bootstrap.Modal(document.getElementById('clientCategories'));
  myModal.hide();
