  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #001219; color: #C70039;">
        <h1 class="modal-title fs-5" id="staticBackdropLabel"><img src="public/KAIROS2.png" alt="LUGMA" width="30" height="30">¡Cerrar sesión!</h1>
        
        <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="closeModCloseSession()"></button>
      </div>
