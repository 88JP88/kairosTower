  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #001219; color: #C70039;">
        ...
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" onclick="closeModClientStores()"></button>
...
<button type="button" class="btn btn-primary1 edit-button1"  style="color: #C70039;" title="VER USUARIOS INACTIVOS"><i class="fas fa-filter" id="filtercatalogsbystoresimple"></i></button>
     ...
     <?php 
     require_once 'layout/formClientStores.php';
     ?>
</div>
...
<script>
function openModClientStores() {
  var myModal = new bootstrap.Modal(document.getElementById('clientStores'));
  myModal.show();
}


function closeModClientStores() {
  var myModal = new bootstrap.Modal(document.getElementById('clientStores'));
  myModal.hide();
