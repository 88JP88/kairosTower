  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-l">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #001219; color: #C70039;">
        ...
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" onclick="closeModClientCategorieCreate()"></button>
      </div>
      <div class="modal-body">
     <?php 
     require_once 'layout/formCreateCategories.php';
     ?>
</div>
...
<script>
function openModClientCategorieCreate() {
  var myModal = new bootstrap.Modal(document.getElementById('clientCategorieCreate'));
  myModal.show();
}


function closeModClientCategorieCreate() {
  var myModal = new bootstrap.Modal(document.getElementById('clientCategorieCreate'));
  myModal.hide();
