...
require_once 'layout/headerAdminSchedule.php';

require_once 'layout/sections.php';
require_once 'modal/modalMyProfile.php';
...
require_once 'modal/modalCalendarDaysAssignAdmin.php';
...
require_once 'modal/modalAssignUserTimeAdmin.php';
