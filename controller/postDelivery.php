...
$name = $_GET['deliveryName'];
$lname = $_GET['deliveryLastName'];
$mail = $_GET['deliveryMail'];
$phone = $_GET['deliveryContact'];
...
$url = $sub_domain . "/kairosGateway/apiClient/v1/postDelivery/fL2jz91ptFMA3UwVkBbu/6WclAmsaP9H7SR2WmpDbl1OL9";

// Definir los datos a enviar en la solicitud POST
$data = array(
    'clientId' => $clientId, 
    'deliveryName' => $name,
    'deliveryLastName' => $lname,
    'deliveryMail' => $mail,
